...
-- 1. Insert 10 Users
INSERT INTO users (id, first_name, last_name, phone_number, email, hashed_password, role, verified) VALUES
(1, 'Admin', 'Admin', '515-515', 'carreon@email.com', 'admin123', 'admin', true),
(2, 'Alex', 'Rivers', '555-0101', 'alex.rivers@example.com', 'password123', 'member', true),
(3, 'Casey', 'Morgan', '555-0102', 'casey.m@example.com', 'mypassword', 'member', true),
(4, 'Jordan', 'Lee', '555-0103', 'jlee_fitness@example.com', '123456', 'member', true),
(5, 'Taylor', 'Swift', '555-0104', 'taylor.s@example.com', 'swiftie2026', 'member', false),
(6, 'Riley', 'Reid', '555-0105', 'riley.r@example.com', 'gymrat99', 'member', true),
(7, 'Quinn', 'Fabray', '555-0106', 'q.fabray@example.com', 'cheer2026', 'member', true),
(8, 'Skyler', 'White', '555-0107', 'skyler.w@example.com', 'bluebird', 'member', true),
(9, 'Charlie', 'Day', '555-0108', 'wildcard@example.com', 'ratprowess', 'member', false),
(10, 'Morgan', 'Freeman', '555-0109', 'voice.god@example.com', 'narration1', 'member', true),
(11, 'Jules', 'Winnfield', '555-0110', 'badmother@example.com', 'ezekiel2517', 'member', true);
...
INSERT INTO attendance_attempts (user_id, action, result, reason, metadata, created_at) VALUES
(4, 'check_in', 'failed', 'No Subscription', '{"source": "mobile_qr", "ar_data": "GYM:in"}', NOW() - INTERVAL '34 days 2 hours');

INSERT INTO attendance_attempts (user_id, action, result, reason, metadata, created_at) VALUES
(6, 'check_in', 'failed', 'No Subscription', '{"source": "mobile_qr", "ar_data": "GYM:in"}', NOW() - INTERVAL '64 days 4 hours');

INSERT INTO attendance_attempts (user_id, action, result, reason, metadata, created_at) VALUES
(5, 'check_in', 'failed', 'Already Checked In', '{"source": "mobile_qr", "ar_data": "GYM:in"}', NOW() - INTERVAL '64 days 4 hours');

INSERT INTO attendance_attempts (user_id, action, result, reason, metadata, created_at) VALUES
(5, 'check_in', 'failed', 'Unverified User', '{"source": "mobile_qr", "ar_data": "GYM:in"}', NOW() - INTERVAL '70 days 4 hours');
