...
--     exercise_name TEXT NOT NULL, -- Specific exercise name (e.g., "Barbell Back Squat")
--     equipment_id INT REFERENCES equipment(id),
    
--     -- Volume parameters
--     sets INT, -- Number of working sets
--     reps INT, -- Target reps per set (use middle of range for rep ranges)
--     duration_minutes INT, -- For cardio or time-based exercises
--     rest_seconds INT, -- Rest between sets
    
--     -- Intensity & technique
--     weight_guidance TEXT, -- e.g., "RPE 7-8", "70% 1RM", "Bodyweight"
--     tempo TEXT, -- e.g., "3-0-1-0" (eccentric-pause-concentric-pause)
    
--     -- Instructions
--     description TEXT, -- Detailed form cues and how to perform
--     notes TEXT, -- Additional coaching notes, tips, modifications
    
--     -- Exercise classification
--     is_warmup BOOLEAN DEFAULT FALSE, -- Flag for warmup/mobility exercises
--     is_superset BOOLEAN DEFAULT FALSE, -- Part of a superset
--     superset_group INT, -- Groups exercises into supersets (1, 2, 3...)
