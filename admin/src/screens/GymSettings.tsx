...
import { useGymDetails, type gymDetailsType } from "../hooks/useGymDetails";
...
export default function GymSettings() {
    ...
    const [formValue, setFormValue] = useState<Partial<gymDetailsType>>({});
    ...
    const handleChange = (key: keyof gymDetailsType, value: string) => {
        setFormValue((prev) => ({
            ...prev,
            [key]: value,
        }));
    ...
    const editableKeys: (keyof gymDetailsType)[] = [
        "gym_name",
        "address",
        "contact_number",
        "email",
        ...
        <div className="p-6 w-full space-y-4">
            ...
            <div className="max-w-md">
                ...
                <button
                    onClick={handleSave}
                    disabled={isSaving}
                    className={`mt-6 w-full py-2 rounded text-background font-semibold transition-colors ${
                        isSaving
                            ? "bg-gray-400"
