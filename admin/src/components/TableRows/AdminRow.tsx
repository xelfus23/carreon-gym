...
import type { ActionItemProps, UserAccountProps } from "../../types";
...
export default function AdminRow({
  ...
  return (
    <tr className={`transition-colors group hover:bg-border/40`}>
      ...
      <td className="p-4">
        <span
          className={`px-2 py-0.5 text-[10px] rounded-full font-bold uppercase tracking-wide ${ACCOUNT_BADGE[m.account_status] ?? "bg-surface text-slate-500"
            }`}
        >
          {m.account_status}
        </span>
