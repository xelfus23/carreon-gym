...
import type { SubscriptionModalProps, SubscriptionPlanProps } from "../../types";
  ...
  return (
    ...
    >
      ...
      >
                  ...
                  {plans.map((plan) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p
                          className={`text-sm font-bold leading-tight ${active
                              ? "text-background"
                              : "text-text-primary"
                            }`}
                        >
              ...
              <section>
                ...
                {hasDiscount && (
                  <p className="flex items-center gap-1.5 text-[11px] text-amber-400 mt-2">
                    ...
                    Adjusted amount — discount or override
                    applied
                  </p>
                )}
              </section>
        ...
        {/* ── Footer ──────────────────────────────────────────────── */}
        <div className="px-6 pb-6 pt-4 border-t border-border shrink-0 space-y-2">
          <button
            type="button"
