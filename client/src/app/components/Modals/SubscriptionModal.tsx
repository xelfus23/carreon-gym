...
interface SubscriptionModalProps {
  visible: boolean;
  onClose: () => void;
  setParams: (v: cartProps) => void;
}

export default function SubscriptionModal({ visible, onClose, setParams }: SubscriptionModalProps) {
        ...
        <View className="left-0 right-0 px-4 pb-8 pt-4 bg-background border-t border-surface">
          <TouchableOpacity
            onPress={() => {
              ...
              setParams({                       // ← this now triggers modal transition
